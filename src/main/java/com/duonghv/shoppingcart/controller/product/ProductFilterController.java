...
import com.duonghv.shoppingcart.repository.product.ProductFilterRepository;
...
public class ProductFilterController {
    ...
    public ResponseEntity<?> getProductVariant(@PathVariable Long id) {
        ProductFilter productFilter = productFilterRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Distributor", "id", id));
