...
import com.duonghv.shoppingcart.repository.product.ProductVariantRepository;
...
public class ProductVariantController {
    ...
    public ResponseEntity<?> getProductVariant(@PathVariable Long id) {
        ProductVariant productVariant = productVariantRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Distributor", "id", id));
